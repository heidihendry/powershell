...
#
#
Add-ADGroupMember "CN=BIS_TEACHERS,OU=Security Groups,OU=Groups,OU=BIS-HN,DC=company,DC=com" –Member $DN #This line can be repeated for any additional groups if necessary
