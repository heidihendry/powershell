...
$path = Split-Path -parent "C:\Users\heidihendry\Documents\ADUsersExport\*.*"
...
$SearchBase = "OU=School-BIH,DC=ap,DC=nordanglia,DC=com"
...
$ADServer = 'BIHAPDC01.ap.nordanglia.com'
