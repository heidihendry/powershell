...
######################################################################## 
$logfile = c:\scripts\pwdlastset\log.txt #fill in your logfile locationpath 
$DN_OU_Path = "OU=Staff,OU=Users,OU=School-BIH,DC=ap,DC=nordanglia,DC=com"#fill in your distinguishedName OU path where the effected users exist. For example: CN=Users,DC=Contoso,DC=local 
$hourschange_sincePwdChange = 23 #fill in the number of hours since the user change his password. For example: 23 (When you run the script on 23:00h) 
